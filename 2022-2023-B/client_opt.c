...
const char *gengetopt_args_info_help[] = {
  ...
  "  -s, --student=INT    student",
  "  -o, --operation=INT  operation",
  "  -t, --phone=INT      phone",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->student_help = gengetopt_args_info_help[4] ;
  args_info->operation_help = gengetopt_args_info_help[5] ;
  args_info->phone_help = gengetopt_args_info_help[6] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->student_orig));
  free_string_field (&(args_info->operation_orig));
  free_string_field (&(args_info->phone_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->student_given)
    write_into_file(outfile, "student", args_info->student_orig, 0);
  if (args_info->operation_given)
    write_into_file(outfile, "operation", args_info->operation_orig, 0);
  if (args_info->phone_given)
    write_into_file(outfile, "phone", args_info->phone_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->student_given)
    {
      fprintf (stderr, "%s: '--student' ('-s') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->operation_given)
    {
      fprintf (stderr, "%s: '--operation' ('-o') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:p:s:o:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 's':	/* student.  */
          ...
          if (update_arg( (void *)&(args_info->student_arg), 
               &(args_info->student_orig), &(args_info->student_given),
              &(local_args_info.student_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "student", 's',
              additional_error))
            goto failure;
        ...
        case 't':	/* phone.  */
          ...
          if (update_arg( (void *)&(args_info->phone_arg), 
               &(args_info->phone_orig), &(args_info->phone_given),
              &(local_args_info.phone_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "phone", 't',
              additional_error))
            goto failure;
