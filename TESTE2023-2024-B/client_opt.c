...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->request_size_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->request_size_given)
    write_into_file(outfile, "request_size", args_info->request_size_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->request_size_given)
    {
      fprintf (stderr, "%s: '--request_size' ('-r') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "ip",	1, NULL, 'i' },
        { "port",	1, NULL, 'p' },
        { "request_size",	1, NULL, 'r' },
        { 0,  0, 0, 0 }
      };

      c = getopt_long (argc, argv, "hVi:p:r:", long_options, &option_index);
