...
struct gengetopt_args_info
{
  ...
  int time_arg;	/**< @brief Time to timeout.  */
  char * time_orig;	/**< @brief Time to timeout original value given at command line.  */
  const char *time_help; /**< @brief Time to timeout help description.  */
